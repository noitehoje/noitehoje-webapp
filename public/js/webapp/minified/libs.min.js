...
(function(b){function j(){url=location.href;return hashtag=url.indexOf("#!")!=-1?decodeURI(url.substring(url.indexOf("#!")+2,url.length)):!1}function h(c,b){var c=c.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]"),e=RegExp("[\\?&]"+c+"=([^&#]*)").exec(b);return e==null?"":e[1]}b.prettyPhoto={version:"3.1.2"};b.fn.prettyPhoto=function(c){function d(){b(".pp_loaderIcon").hide();projectedTop=scroll_pos.scrollTop+(s/2-l.containerHeight/2);projectedTop<0&&(projectedTop=0);$ppt.fadeTo(settings.animation_speed,
...
function(){b(".pp_loaderIcon").show();a()})}function g(a){a>1?b(".pp_nav").show():b(".pp_nav").hide()}function k(a,i){resized=!1;f(a,i);imageWidth=a;imageHeight=i;if((u>t||v>s)&&doresize&&settings.allow_resize&&!q){resized=!0;for(fitting=!1;!fitting;)u>t?(imageWidth=t-200,imageHeight=i/a*imageWidth):v>s?(imageHeight=s-200,imageWidth=a/i*imageHeight):fitting=!0,v=imageHeight,u=imageWidth;f(imageWidth,imageHeight);(u>t||v>s)&&k(u,v)}return{width:Math.floor(imageWidth),height:Math.floor(imageHeight),
containerHeight:Math.floor(v),containerWidth:Math.floor(u)+settings.horizontal_padding*2,contentHeight:Math.floor(m),contentWidth:Math.floor(x),resized:resized}}function f(a,i){a=parseFloat(a);i=parseFloat(i);$pp_details=$pp_pic_holder.find(".pp_details");$pp_details.width(a);detailsHeight=parseFloat($pp_details.css("marginTop"))+parseFloat($pp_details.css("marginBottom"));$pp_details=$pp_details.clone().addClass(settings.theme).width(a).appendTo(b("body")).css({position:"absolute",top:-1E4});detailsHeight+=
$pp_details.height();detailsHeight=detailsHeight<=34?36:detailsHeight;b.browser.msie&&b.browser.version==7&&(detailsHeight+=8);$pp_details.remove();$pp_title=$pp_pic_holder.find(".ppt");$pp_title.width(a);titleHeight=parseFloat($pp_title.css("marginTop"))+parseFloat($pp_title.css("marginBottom"));$pp_title=$pp_title.clone().appendTo(b("body")).css({position:"absolute",top:-1E4});titleHeight+=$pp_title.height();$pp_title.remove();m=i+detailsHeight;x=a;v=m+titleHeight+$pp_pic_holder.find(".pp_top").height()+
...
scrollLeft:document.body.scrollLeft}}function p(){settings.markup=settings.markup.replace("{pp_social}",settings.social_tools?settings.social_tools:"");b("body").append(settings.markup);$pp_pic_holder=b(".pp_pic_holder");$ppt=b(".ppt");$pp_overlay=b("div.pp_overlay");if(isSet&&settings.overlay_gallery){currentGalleryPage=0;toInject="";for(var i=0;i<pp_images.length;i++)pp_images[i].match(/\b(jpg|jpeg|png|gif)\b/gi)?(classname="",img_src=pp_images[i]):(classname="default",img_src=""),toInject+="<li class='"+
...
function(){b(this).remove()}),$pp_overlay.fadeOut(settings.animation_speed,function(){b.browser.msie&&b.browser.version==6&&b("select").css("visibility","visible");settings.hideflash&&b("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css("visibility","visible");b(this).remove();b(window).unbind("scroll.prettyphoto");settings.callback();doresize=!0;r=!1;delete settings}))};!pp_alreadyInitialized&&j()&&(pp_alreadyInitialized=!0,hashRel=hashIndex=j(),hashIndex=hashIndex.substring(hashIndex.indexOf("/")+
...
function parseUri(b){for(var j=parseUri.options,b=j.parser[j.strictMode?"strict":"loose"].exec(b),h={},c=14;c--;)h[j.key[c]]=b[c]||"";h[j.q.name]={};h[j.key[12]].replace(j.q.parser,function(c,b,g){b&&(h[j.q.name][b]=g)});return h}
...
var JSON;JSON||(JSON={});
(function(){function b(c,a){var d,k,i,q,l=e,r,m=a[c];m&&typeof m=="object"&&typeof m.toJSON=="function"&&(m=m.toJSON(c));typeof f=="function"&&(m=f.call(a,c,m));switch(typeof m){case "string":return j(m);case "number":return isFinite(m)?String(m):"null";case "boolean":case "null":return String(m);case "object":if(!m)return"null";e+=g;r=[];if(Object.prototype.toString.apply(m)==="[object Array]"){q=m.length;for(d=0;d<q;d+=1)r[d]=b(d,m)||"null";i=r.length===0?"[]":e?"[\n"+e+r.join(",\n"+e)+"\n"+l+"]":
"["+r.join(",")+"]";e=l;return i}if(f&&typeof f=="object"){q=f.length;for(d=0;d<q;d+=1)k=f[d],typeof k=="string"&&(i=b(k,m),i&&r.push(j(k)+(e?": ":":")+i))}else for(k in m)Object.hasOwnProperty.call(m,k)&&(i=b(k,m),i&&r.push(j(k)+(e?": ":":")+i));i=r.length===0?"{}":e?"{\n"+e+r.join(",\n"+e)+"\n"+l+"}":"{"+r.join(",")+"}";e=l;return i}}function j(c){d.lastIndex=0;return d.test(c)?'"'+c.replace(d,function(a){var c=k[a];return typeof c=="string"?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+
'"':'"'+c+'"'}function h(c){return c<10?"0"+c:c}typeof Date.prototype.toJSON!="function"&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+h(this.getUTCMonth()+1)+"-"+h(this.getUTCDate())+"T"+h(this.getUTCHours())+":"+h(this.getUTCMinutes())+":"+h(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var c=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
typeof JSON.parse!="function"&&(JSON.parse=function(b,a){function d(i,c){var b,g,f=i[c];if(f&&typeof f=="object")for(b in f)Object.hasOwnProperty.call(f,b)&&(g=d(f,b),g!==void 0?f[b]=g:delete f[b]);return a.call(i,c,f)}var g,b=String(b);c.lastIndex=0;c.test(b)&&(b=b.replace(c,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(b.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return g=eval("("+b+")"),typeof a=="function"?d({"":g},""):g;throw new SyntaxError("JSON.parse");})})();
(function(b,j){function h(b,d){var f=d.__amplify__?JSON.parse(d.__amplify__):{};c.addType(b,function(e,a,h){var p=a,i=(new Date).getTime();if(!e){p={};for(e in f)a=(a=d[e])?JSON.parse(a):{expires:-1},a.expires&&a.expires<=i?(delete d[e],delete f[e]):p[e.replace(/^__amplify__/,"")]=a.data;d.__amplify__=JSON.stringify(f);return p}e="__amplify__"+e;if(a===j){if(f[e])if(a=(a=d[e])?JSON.parse(a):{expires:-1},a.expires&&a.expires<=i)delete d[e],delete f[e];else return a.data}else if(a===null)delete d[e],
delete f[e];else{a=JSON.stringify({data:a,expires:h.expires?i+h.expires:null});try{d[e]=a,f[e]=!0}catch(q){c[b]();try{d[e]=a,f[e]=!0}catch(l){throw c.error();}}}d.__amplify__=JSON.stringify(f);return p})}JSON.stringify=JSON.stringify||JSON.encode;JSON.parse=JSON.parse||JSON.decode;var c=b.store=function(b,d,f,e){e=c.type;f&&f.type&&f.type in c.types&&(e=f.type);return c.types[e](b,d,f||{})};c.types={};c.type=null;c.addType=function(b,d){c.type||(c.type=b);c.types[b]=d;c[b]=function(d,e,a){a=a||{};
...
d=b.getAttribute("amplify")?JSON.parse(b.getAttribute("amplify")):{},c.addType("userData",function(e,h,a){var o=h,p=(new Date).getTime(),i,q;if(!e){o={};for(e in d)i=(h=b.getAttribute(e))?JSON.parse(h):{expires:-1},i.expires&&i.expires<=p?(b.removeAttribute(e),delete d[e]):o[e]=i.data;b.setAttribute("amplify",JSON.stringify(d));b.save("amplify");return o}e=e.replace(/[^-._0-9A-Za-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u37f-\u1fff\u200c-\u200d\u203f\u2040\u2070-\u218f]/g,"-");if(h===j){if(e in d)if(i=
(h=b.getAttribute(e))?JSON.parse(h):{expires:-1},i.expires&&i.expires<=p)b.removeAttribute(e),delete d[e];else return i.data}else h===null?(b.removeAttribute(e),delete d[e]):(q=b.getAttribute(e),i=JSON.stringify({data:h,expires:a.expires?p+a.expires:null}),b.setAttribute(e,i),d[e]=!0);b.setAttribute("amplify",JSON.stringify(d));try{b.save("amplify")}catch(l){q===null?(b.removeAttribute(e),delete d[e]):b.setAttribute(e,q);c.userData();try{b.setAttribute(e,i),d[e]=!0,b.save("amplify")}catch(r){throw q===
null?(b.removeAttribute(e),delete d[e]):b.setAttribute(e,q),c.error();}}return o}))})();h("memory",{})})(this.amplify=this.amplify||{});(function(b){var j=b.History=b.History||{},h=b.jQuery;if(typeof j.Adapter!="undefined")throw Error("History.js Adapter has already been loaded...");j.Adapter={bind:function(b,d,e){h(b).bind(d,e)},trigger:function(b,d){h(b).trigger(d)},onDomLoad:function(b){h(b)}};typeof j.init!="undefined"&&j.init()})(window);
(function(b,j){var h=b.console||j,c=b.document,d=b.navigator,e=b.amplify||!1,g=b.setTimeout,k=b.clearTimeout,f=b.setInterval,n=b.JSON,a=b.History=b.History||{},o=b.history;n.stringify=n.stringify||n.encode;n.parse=n.parse||n.decode;if(typeof a.init!="undefined")throw Error("History.js Core has already been loaded...");a.init=function(){if(typeof a.Adapter=="undefined")return!1;typeof a.initCore!="undefined"&&a.initCore();typeof a.initHtml4!="undefined"&&a.initHtml4();return!0};a.initCore=function(){if(typeof a.initCore.initialized!=
...
function(b){return c.discardedHashes[b]||!1};c.recycleState=function(b){var e=c.getHashByState(b);c.discardedState(b)&&delete c.discardedStates[e];return!0};c.emulated.hashChange&&(c.hashChangeInit=function(){c.checkerFunction=null;var d="";if(c.isInternetExplorer()){var e=j.createElement("iframe");e.setAttribute("id","historyjs-iframe");e.style.display="none";j.body.appendChild(e);e.contentWindow.document.open();e.contentWindow.document.close();var g="",k=!1;c.checkerFunction=function(){if(k)return!1;
...
c.emulated.pushState&&(c.onHashChange=function(d){var e=c.getHashByUrl(d&&d.newURL||j.location.href),d=null;if(c.isLastHash(e))return c.busy(!1),!1;c.doubleCheckComplete();c.saveHash(e);if(e&&c.isTraditionalAnchor(e))return c.Adapter.trigger(b,"anchorchange"),c.busy(!1),!1;d=c.extractState(c.getFullUrl(e||j.location.href,!1),!0);if(c.isLastSavedState(d))return c.busy(!1),!1;c.getHashByState(d);if(e=c.discardedState(d))return c.getHashByIndex(-2)===c.getHashByState(e.forwardState)?c.back(!1):c.forward(!1),
...
c.setTitle(f);if(n===a)return c.busy(!1),!1;if(n!==o&&n!==c.getShortUrl(j.location.href))return c.setHash(n,!1),!1;c.saveState(f);c.Adapter.trigger(b,"statechange");c.busy(!1);return!0},c.replaceState=function(b,e,g,h){if(c.getHashByUrl(g))throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(h!==!1&&c.busy())return c.pushQueue({scope:c,callback:c.replaceState,args:arguments,queue:h}),!1;c.busy(!0);var f=c.createStateObject(b,e,g),j=c.getState(!1),a=c.getStateByIndex(-2);
c.discardState(j,f,a);c.pushState(f.data,f.title,f.url,!1);return!0},c.getHash()&&!c.emulated.hashChange&&c.Adapter.onDomLoad(function(){c.Adapter.trigger(b,"hashchange")}))};c.init()})(window);
