...
return $("body").click(function(a){$(a.target).parents(".view-dropdown").length===0&&$(".change-dropdown:visible").hide();if($(a.target).parents(".login").length===0)return $(".login-dropdown:visible").hide()})});e=function(){var a;a=$(window).height()-88;return $("#details").height(a)}}).call(this);
