...
$("#listings").removeClass("small-list").removeClass("large-list").removeClass("map-view");return a==="map-view"?NOITEHOJE.webApp.googleMaps.displayEventsMap():(NOITEHOJE.webApp.location.updateLocationWithScope(""),$("#listings").show().addClass(a),$(".view-dropdown, .view-scope").show(),$("#map_wrapper").hide())});$(".user-panel").click(function(){return $(".services-dropdown").show()});return $("body").click(function(a){$(a.target).parents(".view-dropdown").length===0&&$(".change-dropdown:visible").hide();
$(a.target).parents(".login").length===0&&$(".login-dropdown:visible").hide();if($(a.target).parents(".user-panel").length===0)return $(".services-dropdown:visible").hide()})});e=function(){var a;a=$(window).height()-88;return $("#details").height(a)}}).call(this);
