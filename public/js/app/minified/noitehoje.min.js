...
b=$(this).parents("li");return a&&$(this).text().toUpperCase()!==a.toUpperCase()?b.hide():b.show()})};$(function(){$("a[rel^='prettyPhoto']").prettyPhoto({theme:"dark_rounded",social_tools:!1,opacity:0.5,markup:"        <div class='pp_pic_holder'>          <div class='pp_top'>            <div class='pp_left'></div>            <div class='pp_middle'></div>            <div class='pp_right'></div>          </div>          <a class='pp_close' href='#'>\u00d7 fechar</a>          <div class='pp_content_container'>            <div class='pp_left'>              <div class='pp_right'>                <div class='pp_content'>                  <div class='pp_loaderIcon'></div>                  <div class='pp_fade'>                    <a href='#' class='pp_expand' title='Expand the image'>Expand</a>                    <div class='pp_hoverContainer'>                      <a class='pp_next' href='#'>next</a>                      <a class='pp_previous' href='#'>previous</a>                    </div>                    <div id='pp_full_res'></div>                    <div class='pp_details'>                      <div class='ppt'>&nbsp;</div>                      <div class='pp_nav'>                        <a href='#' class='pp_arrow_previous'>Previous</a>                        <p class='currentTextHolder'>0/0</p>                        <a href='#' class='pp_arrow_next'>Next</a>                      </div>                      <p class='pp_description'></p>                    </div>                  </div>                </div>              </div>            </div>          </div>          <div class='pp_bottom'>            <div class='pp_left'></div>            <div class='pp_middle'></div>            <div class='pp_right'></div>          </div>        </div>        <div class='pp_overlay'></div>"});
$("a.photo-link").click(function(){var a,b;a=$(this);b=a.find("img").attr("src");if(b==="/images/app/party-placeholder.png")return!1;return $.prettyPhoto.open(b,a.data("title"),"")});$(".details-map-wrapper .pp_close").click(function(){$(this).parent().fadeOut();$("#details-map").empty().fadeOut();return $(".details-map-overlay").fadeOut()});return $("a.map-link").click(function(){var a,b,c;$("#details-map, .details-map-wrapper, .details-map-overlay").fadeIn();a=$(this);b=a.attr("data-lat");c=a.attr("data-lon");
