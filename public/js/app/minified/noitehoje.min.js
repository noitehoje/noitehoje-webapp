...
return $("a.photo-link").click(function(){var a,b;a=$(this);b=a.find("img").attr("src");if(b==="/images/app/party-placeholder.png")return!1;return $.prettyPhoto.open(b,a.data("title"),"")})});NOITEHOJE.webApp.eventDetails=function(){return{WEEKDAYS:["Domingo","Segunda","Ter\u00e7a","Quarta","Quinta","Sexta","S\u00e1bado","Domingo"],MONTHS:["Janeiro","Fevereiro","Mar\u00e7o","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],formatDateTime:function(a){var b;b=new Date(Date.parse(a.start_date));
...
return FB.XFBML.parse(b.get(0))},populateFacebookComments:function(){var a;a=$("#details .details-comments");a.empty().append("<fb:comments href='"+window.location.href+"' num_posts='10' width='545' colorscheme='dark'></fb:comments>");return FB.XFBML.parse(a.get(0))},isEventDetailsOpen:function(){return $("#details").attr("data-opened")==="true"},openEventDetailsPanel:function(a,b){var c,d;c=$(".show-event-description");a.description?c.show():c.hide();c=b?$("#details").show().css("right",0).attr("data-opened",
!0):$("#details").show().stop().animate({right:0,300:300}).attr("data-opened",!0);c.find("h2 .event-title").text(a.title);c.find("span.venue-name").text(a.venue.name||"");c.find("p.address").text(a.venue.location.street||"");c.find("p.description").html(a.description||"");c.find("p.phone").text(a.venue.phone||"");a.venue.url&&(d=a.venue.url.indexOf("http://")<0?"http://"+a.venue.url:a.venue.url);c.find("p.site a").attr("href",d||"").text(d||"");c.find("h3 .date").text(this.formatDateTime(a));c.find(".twitter-share-button").attr("src",
this.getTwitterIframeSrc(a));this.refreshFacebookLikeButton(a);c.find("img.photo").attr("src",a.flyer||a.venue.image||"/images/app/party-placeholder.png");c.find("a.photo-link").attr("href",a.flyer||a.venue.image||"/images/app/party-placeholder.png").data("title",a.title);c.find(".source-data").text(a.source);$(".show-event-description").click();$(".map-link").attr("href","http://maps.google.com.br/?ll="+a.venue.location.geo_lat+","+a.venue.location.geo_lon);return c.find("span.event-type-icon").removeClass("party").removeClass("show").addClass(a.evt_type)},
closeDetailsPanel:function(){$("#listings li").removeClass("current");$("#details").stop().animate({right:-600,200:200}).attr("data-opened",!1);return setTimeout("$('#details').hide()",200)},getEventDetails:function(a){return $.getJSON(""+location.protocol+"//"+location.host+"/geteventjson/"+a)}}}();$(function(){$("#details").attr("data-opened",!1);$(".tabs-control li").click(function(a){a.preventDefault();$(".tabs-control li").removeClass("current");a=$(this).attr("class");$(this).addClass("current");
$("#details").find("p.description, .details-ppl-checkd-in, .details-comments").hide();if(a==="show-event-description")return $("#details p.description").show();else if(a==="show-ppl-checkd-in")return $("#details .details-ppl-checkd-in").show();else if(a==="show-comments")return $("#details .details-comments").show(),NOITEHOJE.webApp.eventDetails.populateFacebookComments()});$("#listings li .vevent").live("click",function(a){var b;a.preventDefault();$("#listings li").removeClass("current");a=$(this).parent().addClass("current").end().attr("id");
b=$(this);b.find(".event_loader").show();return NOITEHOJE.webApp.eventDetails.getEventDetails(a).success(h(function(a){NOITEHOJE.webApp.location.updatePageTitle(a);NOITEHOJE.webApp.eventDetails.openEventDetailsPanel(a);return NOITEHOJE.webApp.location.updateLocationForEventDetails(b.attr("href"))},this)).complete(h(function(){return b.find(".event_loader").hide()},this))});return $("#details a.close-panel, #listings .current").click(function(a){a.preventDefault();NOITEHOJE.webApp.eventDetails.closeDetailsPanel();
NOITEHOJE.webApp.location.updateLocationForEventDetails();NOITEHOJE.webApp.googleMaps.unselectCurrentMarker();return NOITEHOJE.webApp.location.updatePageTitle()})});$(function(){window.fbAsyncInit=function(){return FB.init({appId:NOITEHOJE.webApp.facebookAppId,status:!0,cookie:!0,xfbml:!0})};FB.Event.subscribe("auth.login",function(){});$.browser.msie&&$("body").addClass("msie");e();$(window).bind("resize",e);$(".view-scope a").click(function(a){var b;a.preventDefault();$(".view-scope a").removeClass("selected");
$(this).addClass("selected");b=$(this).data("view-scope");a="Eventos";b==="any"?$(".vevent").show():(a=b==="party"?"Festas":"Shows",$(".vevent[data-event-type!='"+b+"']").hide(),$(".vevent[data-event-type='"+b+"']").show());NOITEHOJE.webApp.location.listingEventTypes=a;NOITEHOJE.webApp.location.updatePageTitle();return NOITEHOJE.webApp.location.updateLocationWithScope(b)});$("#about").click(function(a){a.preventDefault();NOITEHOJE.webApp.location.updateLocationWithScope("about");return $("#modal-window").fadeIn(500)});
$(".close-modal").click(function(a){a.preventDefault();NOITEHOJE.webApp.location.updateLocationWithScope("");return $("#modal-window").fadeOut(200)});$(".view-type a").click(function(a){a.preventDefault();a=$(this).data("view-type");$(".view-type a").removeClass("current");$(this).addClass("current");$("#listings").removeClass("small-list").removeClass("large-list").removeClass("map-view");return a==="map-view"?NOITEHOJE.webApp.googleMaps.displayEventsMap():(NOITEHOJE.webApp.location.updateLocationWithScope(""),
$("#listings").show().addClass(a),$(".view-dropdown, .view-scope").show(),$("#map_wrapper").hide())});$(".user-panel").click(function(){return $(".services-dropdown").show()});setTimeout(function(){return $(".flash").fadeOut()},3E3);return $("body").click(function(a){$(a.target).parents(".view-dropdown").length===0&&$(".change-dropdown:visible").hide();$(a.target).parents(".login").length===0&&$(".login-dropdown:visible").hide();if($(a.target).parents(".user-panel").length===0)return $(".services-dropdown:visible").hide()})});
e=function(){var a;a=$(window).height()-88;return $("#details").height(a)}}).call(this);
