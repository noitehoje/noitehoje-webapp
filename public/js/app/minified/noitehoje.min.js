...
$("#listings").removeClass("small-list").removeClass("large-list").removeClass("map-view");return a==="map-view"?NOITEHOJE.webApp.googleMaps.displayEventsMap():(NOITEHOJE.webApp.location.updateLocationWithScope(""),$("#listings").show().addClass(a),$(".view-dropdown, .view-scope").show(),$("#map_wrapper").hide())});$("#user-login").click(function(a){a.preventDefault();return $(".login-dropdown").show()});$("#user-account").click(function(a){a.preventDefault();return $(".services-dropdown").show()});
return $("body").click(function(a){$(a.target).parents(".view-dropdown").length===0&&$(".change-dropdown:visible").hide();$(a.target).parents(".login").length===0&&$(".login-dropdown:visible").hide();if($(a.target).attr("id")!=="user-account")return $(".services-dropdown:visible").hide()})});e=function(){var a;a=$(window).height()-88;return $("#details").height(a)}}).call(this);
